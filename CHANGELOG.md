...
* [ENHANCEMENT] Querier: add `cortex_bucket_store_series_non_compacted_blocks_queried` metric that indicates the number of non-compacted blocks that were queried from store gateways. #7112
